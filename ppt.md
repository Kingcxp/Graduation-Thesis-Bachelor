...
- <danger>内核强耦合</danger>：需要替换宿主机内核（较旧），新的机器**无法运行**，需要解决**大量的问题**
- <danger>构建链断层</danger>：代码仓库缺失核心 Make 目标，部分代码存在严重的逻辑问题无法运行
...
至此，整个 **Moneta** 的构建过程已经完全自动化，并且已经脱离了对宿主机内核的依赖，解决了所有代码运行上的缺陷和问题，已经是一个比较成熟的测试框架了！
